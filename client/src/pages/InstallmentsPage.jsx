  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 font-medium mt-1">
            Manage installment payment schedules for fisher debts.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#111827] text-white hover:bg-slate-800 text-sm font-bold shadow-sm transition-all cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Manual Review</span>
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-2 overflow-x-auto w-full md:w-auto">
          {[
            ...
            { id: 'OVERDUE_REVIEW', label: 'Overdue' },
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-2xs overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center text-slate-400 font-medium">No installment plans.</div>
        ) : (
                  ...
                  {isExpanded && (
                    <div className="px-5 pb-5 pt-2 bg-slate-50/70 border-t border-slate-100 space-y-3">
                      <div className="flex items-center justify-between text-xs font-bold text-slate-600">
                        <span>Dues Schedule ({plan.totalDuesCount} installments)</span>
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/50 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto p-6 space-y-5">
            <div className="flex items-center justify-between border-b pb-3 border-slate-100">
              <h3 className="text-lg font-black text-[#111827]">Add Installment Plan</h3>
              <button
                onClick={() => {
                  setIsCreateModalOpen(false);
                  resetCreateForm();
            ...
            <form onSubmit={handleCreatePlan} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  required
                  className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-medium text-slate-800 focus:outline-none focus:border-slate-400 cursor-pointer"
                >
              ...
              <button
                ...
                className="w-full py-2 border border-slate-300 rounded-xl text-xs font-bold text-slate-700 hover:bg-slate-50 transition-colors cursor-pointer"
              >
                Preview Schedule
              </button>
              ...
              <div className="flex justify-end gap-3 pt-3 border-t border-slate-100">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-[#111827] text-white hover:bg-slate-800 text-xs font-bold shadow-sm cursor-pointer disabled:opacity-50"
                >
                  {createSubmitting ? 'Activating...' : 'Create Plan'}
                </button>
              </div>
            </form>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-xl max-w-md w-full p-6 space-y-4">
            ...
            <p className="text-xs text-slate-600">
              ...
              <span className="text-rose-600 font-semibold block mt-1">
                Underlying debt returns to OUTSTANDING hold.
              </span>
            </p>
            ...
            <form onSubmit={handleCancelPlan} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-rose-600 text-white hover:bg-rose-700 text-xs font-bold shadow-sm cursor-pointer disabled:opacity-50"
                >
